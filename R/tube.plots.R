...
#         THINK THIS IS NOW FIXED as of 0.1.1.3...
#             MAYBE test...
#         related...
...
#             also have possible repairMetaData option in notes...
...
# tubePlot line/multi-facet issue
#         (moved to needs/ now working/fixing...)
